...
<td>
<em>(Optional)</em>
<p>This flag tells the controller to suspend subsequent policy evaluations.
It does not apply to already started evaluations. Defaults to false.</p>
</td>
</tr>
</table>
</td>
...
<tr>
<td>
<code>lastHandledReconcileRequest</code><br>
<em>
string
</em>
</td>
<td>
<p>LastHandledReconcileRequest holds the value of the most recent
reconcile request value, so a change can be detected.</p>
</td>
</tr>
</tbody>
</table>
