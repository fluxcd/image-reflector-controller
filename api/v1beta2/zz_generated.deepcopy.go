...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageAndAttributes) DeepCopyInto(out *ImageAndAttributes) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageAndAttributes.
func (in *ImageAndAttributes) DeepCopy() *ImageAndAttributes {
	if in == nil {
		return nil
	}
	out := new(ImageAndAttributes)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ImagePolicyStatus) DeepCopyInto(out *ImagePolicyStatus) {
	*out = *in
	if in.Distribution != nil {
		...
		*out = make(map[string]ImageAndAttributes, len(*in))
		for key, val := range *in {
